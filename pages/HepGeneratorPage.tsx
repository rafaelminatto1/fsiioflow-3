        ...
        if (selectedPatientId) {
            ...
            if (patient) {
                setFormData(prev => ({
                    ...
                    diagnostico_paciente: 'Lombalgia mecânica',
                ...
                <div className="bg-white p-6 rounded-2xl shadow-sm">
                    <div className="flex justify-between items-center mb-4">
                        ...
                        <div className="flex gap-2">
                             <button onClick={handleSendWhatsApp} disabled={!hep} className="inline-flex items-center px-3 py-1.5 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-green-500 hover:bg-green-600 disabled:opacity-50">
